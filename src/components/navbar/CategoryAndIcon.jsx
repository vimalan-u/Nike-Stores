...
//     try {
//       console.log("hi");
//       let searchedProducts = await axios(
//         `/product/getsearchedproduct?query=${searchInput.trim()}`
//       );
//       console.log("searched_products", searchedProducts);
...
//           <PopoverContent mt={10}>
//             <PopoverHeader>Products</PopoverHeader>
//             <PopoverCloseButton />
//             <PopoverBody>
//               <List
//                 maxHeight="400px"
